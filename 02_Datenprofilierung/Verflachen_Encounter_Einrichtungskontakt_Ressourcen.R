...
encounterRequest <- fhir_url(url="http://g09a004:28080/fhir", resource="Encounter", parameters = c("type" = "einrichtungskontakt"))
...
write.csv(x = encounters, file = "fhircrackr/encounterEK.csv", na="")
